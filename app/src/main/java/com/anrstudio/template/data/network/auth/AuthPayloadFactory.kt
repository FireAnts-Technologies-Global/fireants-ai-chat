...
class AuthPayloadFactory @Inject constructor(
    ...
    fun buildRefreshBearer(
        method: String,
        path: String,
        refreshToken: String = authInfoProvider.refreshToken
    ): String? {
    ...
    fun buildAccessBearer(
        method: String,
        path: String,
        accessToken: String = authInfoProvider.accessToken
    ): String? {
    ...
    private fun encrypt(payload: Map<String, Any?>): String? {
        ...
        val context = GlobalApp.instance
