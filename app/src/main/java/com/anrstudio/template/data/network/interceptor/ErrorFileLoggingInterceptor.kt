package com.anrstudio.template.data.network.interceptor

import android.content.Context
import com.anrstudio.template.data.network.auth.AuthDebugInfo
...
class ErrorFileLoggingInterceptor(private val context: Context) : Interceptor {
    ...
    private fun writeErrorLog(request: Request, response: Response) {
        try {
