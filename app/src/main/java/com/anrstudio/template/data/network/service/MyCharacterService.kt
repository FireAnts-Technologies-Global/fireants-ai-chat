...
import com.pegas.aura.aigirlfriend.soul.data.network.model.mycharacter.CreateMyCharacterRequestDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.mycharacter.GenerateMyCharacterImageRequestDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.mycharacter.MyCharacterEnvelopeDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.mycharacter.MyCharacterGenerateImageEnvelopeDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.mycharacter.MyCharacterGuideEnvelopeDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.mycharacter.MyCharacterImageStatusEnvelopeDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.mycharacter.MyCharactersEnvelopeDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.mycharacter.UpdateMyCharacterRequestDto
...
interface MyCharacterService {
    ...
    suspend fun getCreationGuide(): MyCharacterGuideEnvelopeDto
