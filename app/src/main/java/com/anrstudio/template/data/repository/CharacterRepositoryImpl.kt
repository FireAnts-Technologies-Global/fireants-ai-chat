...
import com.anrstudio.template.data.network.model.base.requireData
import com.anrstudio.template.data.network.model.character.toDomain
...
class CharacterRepositoryImpl @Inject constructor(
    ...
    override suspend fun getCharacterCategories(query: PaginationQuery): AppResult<CharacterCategoryPage> =
        apiResult("getCharacterCategories") {
            characterService.getCharacterCategories(query.page, query.limit).requireData()
                .toDomain()
        }
    ...
    override suspend fun getCharactersByCategoryQuery(
        ...
        characterService.getCharactersByCategoryQuery(query.page, query.limit, categorySlug)
    ...
    override suspend fun getCharactersByCategoryPath(
        ...
        characterService.getCharactersByCategoryPath(categorySlug, query.page, query.limit)
            .requireData().toDomain()
    }
