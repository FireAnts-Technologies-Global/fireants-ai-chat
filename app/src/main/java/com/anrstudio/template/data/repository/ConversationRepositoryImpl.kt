...
import com.pegas.aura.aigirlfriend.soul.data.local.conversation.ConversationLocalDataSource
import com.pegas.aura.aigirlfriend.soul.data.network.model.base.envelopeAdapter
import com.pegas.aura.aigirlfriend.soul.data.network.model.conversation.ConversationDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.conversation.ConversationMessageDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.conversation.CreateConversationRequestDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.conversation.DeleteConversationDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.conversation.SendChatMessageRequestDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.conversation.SendChatResponseDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.conversation.UpdateConversationRequestDto
import com.pegas.aura.aigirlfriend.soul.data.network.model.conversation.toDomain
import com.pegas.aura.aigirlfriend.soul.data.network.model.conversation.withCharacterFallback
