...
import com.anrstudio.template.app.ResumeAdsEntryMode
...
class MainActivity : BaseActivityWithBanner<ActivityMainBinding>() {
    ...
    private fun showSdkVersionInfo() {
        val nkhVersion = BuildConfig.ANRSTUDIO_ADS_VERSION
    ...
    override fun onClickViews() {
        ...
        mBinding.buttonHello.click {
            ANRTrackingHelper.logEventClick(this::class.java.simpleName, "buttonHello", null)
        }
