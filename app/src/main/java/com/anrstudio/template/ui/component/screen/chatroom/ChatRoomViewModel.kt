...
import com.pegas.aura.aigirlfriend.soul.domain.model.report.ReportClientMeta
import com.pegas.aura.aigirlfriend.soul.domain.usecase.auth.GetAuthUserFlowUseCase
import com.pegas.aura.aigirlfriend.soul.domain.usecase.character.GetCharacterBackgroundsUseCase
import com.pegas.aura.aigirlfriend.soul.domain.usecase.character.GetCharacterProgressUseCase
import com.pegas.aura.aigirlfriend.soul.domain.usecase.coins.GetCoinBalanceUseCase
import com.pegas.aura.aigirlfriend.soul.domain.usecase.conversation.DeleteConversationUseCase
import com.pegas.aura.aigirlfriend.soul.domain.usecase.conversation.GetCachedConversationByIdUseCase
import com.pegas.aura.aigirlfriend.soul.domain.usecase.conversation.GetConversationMessagesUseCase
import com.pegas.aura.aigirlfriend.soul.domain.usecase.conversation.GetConversationUseCase
import com.pegas.aura.aigirlfriend.soul.domain.usecase.conversation.GetQuickPromptsUseCase
import com.pegas.aura.aigirlfriend.soul.domain.usecase.conversation.SendChatMessageUseCase
import com.pegas.aura.aigirlfriend.soul.domain.usecase.conversation.UpdateConversationUseCase
import com.pegas.aura.aigirlfriend.soul.domain.usecase.report.SubmitReportUseCase
import com.pegas.aura.aigirlfriend.soul.ui.analytics.ChatActionTracker
                ...
                is AppResult.Success -> {
                    if (result.data) {
                        ...
                        updateState {
                            copy(
                                isLoading = false,
                                error = com.pegas.aura.aigirlfriend.soul.domain.model.common.PublicError(
                                    com.pegas.aura.aigirlfriend.soul.domain.model.common.PublicMessageKey.GENERIC_ERROR
                                )
                            )
                        }
                    }
