...
object ANRTrackingHelper {
     ...
     */
    fun userProperty(name: String, value: String): ANRTrackingHelper {
     ...
     */
    fun logEvent(eventName: String, params: Bundle?): ANRTrackingHelper {
    ...
    fun logEventClick(
        ...
        Log.d("ANRStudioTrackingHelper", "logEvent: $activityName click $eventName")
     ...
     */
    fun addScreenTrack(screenName: String): ANRTrackingHelper {
     ...
     * Chỉ gắn cho tracking theo màn hình theo yêu cầu của PM, PO, BA
     */
    fun fromScreenToScreen(fromScreen: String, toScreen: String): ANRTrackingHelper {
        Log.d("ANRStudioTrackingHelper", "fromScreenToScreen: $fromScreen to $toScreen")
