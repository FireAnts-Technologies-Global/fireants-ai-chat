package com.pegas.yuki.virtual.chat.data.network.model.coins

import com.pegas.yuki.virtual.chat.data.network.model.base.toDomain
import com.pegas.yuki.virtual.chat.domain.model.coins.CoinAdsBalance
...
import com.pegas.yuki.virtual.chat.domain.model.coins.CoinTransaction
...
fun AdsRewardDto.toDomain(): com.pegas.yuki.virtual.chat.domain.model.coins.AdsReward =
    com.pegas.yuki.virtual.chat.domain.model.coins.AdsReward(
    coinsPerView = coinsPerView ?: 0,
    remainingToday = remainingToday ?: 0
)
