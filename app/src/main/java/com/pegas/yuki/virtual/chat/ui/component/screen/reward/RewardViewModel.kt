...
import com.pegas.yuki.virtual.chat.domain.usecase.coins.ClaimCheckInUseCase
import com.pegas.yuki.virtual.chat.domain.usecase.coins.GetCheckInStateUseCase
import com.pegas.yuki.virtual.chat.domain.usecase.coins.GetCoinBalanceUseCase
import com.pegas.yuki.virtual.chat.domain.usecase.coins.WatchAdUseCase
import com.pegas.yuki.virtual.chat.ui.bases.compose.mvi.BaseComposeViewModel
import com.pegas.yuki.virtual.chat.ui.reward.RewardAdsCoordinator
...
class RewardViewModel @Inject constructor(
    ...
    private fun applyCoinBalance(
        balance: com.pegas.yuki.virtual.chat.domain.model.coins.CoinBalance,
        isVip: Boolean
    ) {
        updateState {
            copy(
    ...
    private fun sendNetworkUnavailable() {
        sendEffect(
            RewardEffect.ShowToast(
                com.pegas.yuki.virtual.chat.domain.model.common.PublicError(
                    com.pegas.yuki.virtual.chat.domain.model.common.PublicMessageKey.NETWORK_UNAVAILABLE
                )
            )
        )
    }
