...
object FireAntsTrackingHelper {
    ...
    fun addScreenTrackCompose(screenName: String): FireAntsTrackingHelper {
        Firebase.analytics.logEvent(screenName, null)
    ...
    fun fromScreenToScreenCompose(fromScreen: String, toScreen: String): FireAntsTrackingHelper {
        Firebase.analytics.logEvent(FirebaseAnalytics.Event.SCREEN_VIEW) {
