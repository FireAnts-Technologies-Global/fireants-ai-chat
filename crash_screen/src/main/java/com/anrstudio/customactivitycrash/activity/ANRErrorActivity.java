package com.anrstudio.customactivitycrash.activity;
...
import com.anrstudio.customactivitycrash.CustomActivityOnCrash;
import com.anrstudio.customactivitycrash.config.ANRCrashConfig;
import com.anrstudio.customactivityoncrash.R;


public final class ANRErrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anr_crash);
        ...
        final ANRCrashConfig config = CustomActivityOnCrash.getConfigFromIntent(getIntent());
        ...
        if (config.isShowRestartButton() && config.getRestartActivityClass() != null) {
            ...
            restartButton.setOnClickListener(v -> CustomActivityOnCrash.restartApplication(ANRErrorActivity.this, config));
        } else {
            restartButton.setOnClickListener(v -> CustomActivityOnCrash.closeApplication(ANRErrorActivity.this, config));
        }
        ...
        if (config.isShowErrorDetails()) {
            moreInfoButton.setOnClickListener(v -> {
                String fullErrorDetails = CustomActivityOnCrash.getAllErrorDetailsFromIntent(ANRErrorActivity.this, getIntent());
    ...
    private void copyErrorToClipboard() {
        String errorInformation = CustomActivityOnCrash.getAllErrorDetailsFromIntent(ANRErrorActivity.this, getIntent());
        ...
        if (clipboard != null) {
            ...
            Toast.makeText(ANRErrorActivity.this, R.string.error_details_copied, Toast.LENGTH_SHORT).show();
        }
    }
