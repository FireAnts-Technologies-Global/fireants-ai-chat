package com.anrstudio.customactivitycrash.config;
...
public class ANRCrashConfig implements Serializable {
    ...
    public static class Builder {
        private ANRCrashConfig config;

        @NonNull
        public static Builder create() {
            Builder builder = new Builder();
            ANRCrashConfig currentConfig = CustomActivityOnCrash.getConfig();

            ANRCrashConfig config = new ANRCrashConfig();
